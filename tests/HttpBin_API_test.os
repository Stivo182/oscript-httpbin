...
Процедура ПриСозданииОбъекта()
	...
	ИмяХоста = "127.0.0.1"; // BSLLS:UsingHardcodeNetworkAddress-off
	Порт = 3334;
...
Функция URL(АдресРсесурса)
	Возврат СтрШаблон("http://%1:%2/%3", ИмяХоста, Формат(Порт, "ЧГ="), АдресРсесурса);
КонецФункции
